...
| 22 | Aux LV Overvoltage WARN | `aux_status` | `AuxOverVoltageWarning` |
| 23 | Aux LV Undervoltage WARN | `aux_status` | `AuxUnderVoltageWarning` |
| 24 | Aux LV Overcurrent WARN | `aux_status` | `AuxOverCurrentWarning` |
| 25 | Aux LV Undercurrent WARN | `aux_status` | `AuxUnderCurrentWarning` |
| 26 | Motor Temp Limit | `mc_limit_flags` | `McLimitFlags::IpmMotorTemperature` active |
| 27 | Main LV Overvoltage ERROR | `main_status` | `MainOverVoltageError` |
| 28 | Main LV Undervoltage ERROR | `main_status` | `MainUnderVoltageError` |
| 29 | Main LV Overcurrent ERROR | `main_status` | `MainOverCurrentError` |
| 30 | Main LV Undercurrent ERROR | `main_status` | `MainUnderCurrentError` |
